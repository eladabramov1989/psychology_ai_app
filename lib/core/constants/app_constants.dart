class AppConstants {
  ...
  // API Configuration
  static const String aiEndpoint = 'https://api.together.xyz/v1/chat/completions'; // Together.ai API endpoint
  static const String aiApiKey = 'tgp_v1_9WMSL-ApQtIFXy_iNzZy_AR0YzEFCNaxs9QtTqqWCz0'; // Together.ai API key
  static const String aiModel = 'NousResearch/Nous-Hermes-2-Mixtral-8x7B-DPO'; // Together.ai serverless model
